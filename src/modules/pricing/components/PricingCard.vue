<template>
  <section id="pricing-card">
    <div class="p-8 border rounded-3xl">
      ...
      <a
        href="checkout.html"
        class="inline-flex items-center justify-center w-full mt-0 md:mt-8 px-8 py-3 text-base font-medium border border-transparent rounded-full md:py-2 md:text-md md:px-10 hover:shadow"
        :class="[
          title === 'Gold Plan'
